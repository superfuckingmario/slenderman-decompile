...
public class BloomAndLensFlares : PostEffectsBase
{
	...
	public virtual void OnDisable()
	{
		...
		if ((bool)lensFlareMaterial)
		{
			UnityEngine.Object.DestroyImmediate(lensFlareMaterial);
		}
		if ((bool)vignetteMaterial)
		{
			UnityEngine.Object.DestroyImmediate(vignetteMaterial);
		}
		if ((bool)separableBlurMaterial)
		{
			UnityEngine.Object.DestroyImmediate(separableBlurMaterial);
		}
		if ((bool)addBrightStuffBlendOneOneMaterial)
		{
			UnityEngine.Object.DestroyImmediate(addBrightStuffBlendOneOneMaterial);
		}
		if ((bool)hollywoodFlaresMaterial)
		{
			UnityEngine.Object.DestroyImmediate(hollywoodFlaresMaterial);
		}
		if ((bool)brightPassFilterMaterial)
		{
