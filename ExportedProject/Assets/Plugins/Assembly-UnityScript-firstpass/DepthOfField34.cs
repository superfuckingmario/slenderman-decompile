...
public class DepthOfField34 : PostEffectsBase
{
	...
	{
		Quads.Cleanup();
		if ((bool)dofBlurMaterial)
		{
			UnityEngine.Object.DestroyImmediate(dofBlurMaterial);
		}
		if ((bool)dofMaterial)
		{
			UnityEngine.Object.DestroyImmediate(dofMaterial);
		}
		if ((bool)bokehMaterial)
		{
			UnityEngine.Object.DestroyImmediate(bokehMaterial);
		}
	}
